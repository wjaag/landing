...
<footer class="site-footer">
	<div class="container site-footer__inner">
		...
		<nav class="site-footer__nav" aria-label="<?php esc_attr_e( 'Menu w stopce', 'autoserwis' ); ?>">
			<a href="#uslugi"><?php esc_html_e( 'Usługi', 'autoserwis' ); ?></a>
			<a href="#proces"><?php esc_html_e( 'Jak działamy', 'autoserwis' ); ?></a>
			<a href="#zakres"><?php esc_html_e( 'Zakres usług', 'autoserwis' ); ?></a>
			<a href="#kontakt"><?php esc_html_e( 'Kontakt', 'autoserwis' ); ?></a>
		</nav>
